...
> One conversation-history backend. It owns its config, its wire encoding, and
...
- The implementation of the store capabilities in `core/history` that this
  service genuinely supports.
