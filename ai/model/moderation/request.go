...
// Request represents a moderation request containing input text and configuration
type Request struct {
	// Input is the text content to be moderated
...
// NewRequest creates a new Request instance with the specified input text
