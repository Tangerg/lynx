...
func TestNewSimpleFormatter(t *testing.T) {
	t.Run("with nil config", func(t *testing.T) {
		...
		assert.NotNil(t, formatter.config.ExcludedInferenceMetadataKeys)
		assert.NotNil(t, formatter.config.ExcludedEmbedMetadataKeys)
		assert.Empty(t, formatter.config.ExcludedInferenceMetadataKeys)
		assert.Empty(t, formatter.config.ExcludedEmbedMetadataKeys)
	})
	...
	t.Run("with full config", func(t *testing.T) {
		...
		require.NotNil(t, formatter)
		assert.Equal(t, config.ExcludedInferenceMetadataKeys, formatter.config.ExcludedInferenceMetadataKeys)
		assert.Equal(t, config.ExcludedEmbedMetadataKeys, formatter.config.ExcludedEmbedMetadataKeys)
	})
...
func TestSimpleFormatter_Format(t *testing.T) {
	t.Run("format with no metadata - mode all", func(t *testing.T) {
		...
		result := formatter.Format(doc, document.MetadataModeAll)
	...
	t.Run("format with metadata - mode none", func(t *testing.T) {
		...
		result := formatter.Format(doc, document.MetadataModeNone)
	...
	t.Run("format with excluded inference metadata", func(t *testing.T) {
		...
		result := formatter.Format(doc, document.MetadataModeInference)
	...
	t.Run("format with excluded embed metadata", func(t *testing.T) {
		...
		result := formatter.Format(doc, document.MetadataModeEmbed)
...
func TestSimpleFormatter_filterMetadataByMode(t *testing.T) {
	t.Run("mode all returns all metadata", func(t *testing.T) {
		...
		result := formatter.filterMetadataByMode(metadata, document.MetadataModeAll)
	...
	t.Run("mode none returns empty map", func(t *testing.T) {
		...
		result := formatter.filterMetadataByMode(metadata, document.MetadataModeNone)
	...
	t.Run("mode inference excludes configured keys", func(t *testing.T) {
		...
		result := formatter.filterMetadataByMode(metadata, document.MetadataModeInference)
	...
	t.Run("mode embed excludes configured keys", func(t *testing.T) {
		...
		result := formatter.filterMetadataByMode(metadata, document.MetadataModeEmbed)
...
func TestSimpleFormatter_InterfaceCompliance(t *testing.T) {
	formatter := NewDefaultSimpleFormatter()
	var _ document.Formatter = formatter
}
...
func TestSimpleFormatter_Integration(t *testing.T) {
	t.Run("complete formatting workflow", func(t *testing.T) {
		...
		// Test all mode
		resultAll := formatter.Format(doc, document.MetadataModeAll)
		...
		// Test inference mode
		resultInference := formatter.Format(doc, document.MetadataModeInference)
		...
		// Test embed mode
		resultEmbed := formatter.Format(doc, document.MetadataModeEmbed)
		...
		// Test none mode
		resultNone := formatter.Format(doc, document.MetadataModeNone)
	...
	t.Run("multiple formatters with same document", func(t *testing.T) {
		...
		result1 := formatter1.Format(doc, document.MetadataModeInference)
		result2 := formatter2.Format(doc, document.MetadataModeInference)
