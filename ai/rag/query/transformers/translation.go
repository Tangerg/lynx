...
// TranslationTransformerConfig holds the configuration for TranslationTransformer.
...
var _ rag.QueryTransformer = (*TranslationTransformer)(nil)

// TranslationTransformer uses a large language model to translate a query to a target
