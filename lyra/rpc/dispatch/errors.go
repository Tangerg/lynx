...
// sentinelToCode maps each protocol sentinel error to its wire code.
...
var sentinelToCode = map[error]int{
	protocol.ErrSessionNotFound:         transport.CodeSessionNotFound,
	protocol.ErrMessageNotFound:         transport.CodeMessageNotFound,
	protocol.ErrRunNotFound:             transport.CodeRunNotFound,
	protocol.ErrAttachmentTooLarge:      transport.CodeAttachmentTooLarge,
	protocol.ErrCapabilityNotNegotiated: transport.CodeCapabilityNotNegotiated,
	protocol.ErrInvalidProtocolVersion:  transport.CodeInvalidProtocolVersion,
	protocol.ErrProtocolViolation:       transport.CodeProtocolViolation,
	protocol.ErrApprovalRequired:        transport.CodeApprovalRequired,
	protocol.ErrProviderError:           transport.CodeProviderError,
	protocol.ErrProviderRateLimited:     transport.CodeProviderRateLimited,
	protocol.ErrToolFailed:              transport.CodeToolFailed,
}
