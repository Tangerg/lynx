...
func (i *Server) Initialize(_ context.Context, _ coreapi.InitializeRequest) (*coreapi.InitializeResponse, error) {
	...
	return &coreapi.InitializeResponse{
...
func (i *Server) Shutdown(_ context.Context, _ coreapi.ShutdownRequest) error {
	return nil
}
