...
func (i *Impl) CreateUploadURL(_ context.Context, _ coreapi.CreateUploadURLIn) (*coreapi.CreateUploadURLOut, error) {
	return nil, notImpl("attachments.createUploadUrl")
}

func (i *Impl) DeleteAttachment(_ context.Context, _ string) error {
...
func (i *Impl) ListBackground(_ context.Context) ([]coreapi.BackgroundTask, error) {
	return []coreapi.BackgroundTask{}, nil
}

func (i *Impl) StopBackground(_ context.Context, _ string) error {
	return notImpl("background.stop")
}

func (i *Impl) SubscribeBackground(_ context.Context, _ string) (<-chan coreapi.BackgroundUpdate, error) {
...
func (i *Impl) SubmitFeedback(_ context.Context, _ coreapi.FeedbackIn) error {
	return nil
}
