...
| Path | Contents |
|---|---|
| [`bug-reports/`](bug-reports/README.md) | One file per defect found while testing, so implementation fixes are batched separately from the tests that exposed them |
