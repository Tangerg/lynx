module github.com/Tangerg/lynx/dev/providerconformance
...
require (
	...
	github.com/Tangerg/lynx/tools/webfetch/exa v0.0.0
	github.com/Tangerg/lynx/tools/webfetch/firecrawl v0.0.0
	github.com/Tangerg/lynx/tools/webfetch/jina v0.0.0
	github.com/Tangerg/lynx/tools/webfetch/tavily v0.0.0
	github.com/Tangerg/lynx/tools/websearch/brave v0.0.0
	github.com/Tangerg/lynx/tools/websearch/exa v0.0.0
	github.com/Tangerg/lynx/tools/websearch/firecrawl v0.0.0
	github.com/Tangerg/lynx/tools/websearch/jina v0.0.0
	github.com/Tangerg/lynx/tools/websearch/perplexity v0.0.0
	github.com/Tangerg/lynx/tools/websearch/serper v0.0.0
