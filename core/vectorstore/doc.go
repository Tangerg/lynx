...
//
//   - filter: Expression-based metadata filtering (github.com/Tangerg/lynx/core/vectorstore/filter)
//   - document: Document abstraction and processing (github.com/Tangerg/lynx/core/document)
