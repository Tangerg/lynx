...
func systemMessages(msgs []Message) []Message {
	return FilterMessagesByMessageTypes(msgs, MessageTypeSystem)
}
...
func interruptedConversation(assistant *AssistantMessage, done []*ToolReturn) []Message {
...
// wrapInterrupt builds the *ToolLoopInterrupted carrying the resume
// checkpoint (the assistant tool-call message + the results already
// produced this round) around the tool's interrupt cause.
func (m *ToolMiddleware) wrapInterrupt(assistant *AssistantMessage, done []*ToolReturn, cause error) error {
