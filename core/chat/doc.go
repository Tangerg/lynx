...
// ReasoningEffort carries the model-advertised intensity vocabulary without
// imposing one provider's closed enum, and OutputFormat describes the requested
// representation without adopting any provider's wire naming. Namespaced
// Extensions preserve provider data without expanding the shared protocol for
