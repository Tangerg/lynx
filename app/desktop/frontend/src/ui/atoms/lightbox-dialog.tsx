    ...
    <DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Popup
          ...
          className={cn(
            "fixed inset-0 z-[201] m-auto h-fit w-fit max-h-[90vh] max-w-[min(1400px,95vw)] overflow-auto rounded-[var(--floating-panel-radius)] bg-card shadow-[var(--shadow-popover)] outline-none data-[open]:animate-rise-in",
