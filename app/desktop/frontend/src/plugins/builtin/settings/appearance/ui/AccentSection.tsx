...
function CustomAccentPicker({
  ...
  return (
    <label
      ...
      aria-label={label}
      className={cn(
        "relative inline-grid h-4.5 w-4.5 place-items-center rounded-full border-2 border-transparent bg-clip-padding transition-[transform,box-shadow] duration-150 active:scale-[0.96]",
      ...
      <div className="flex flex-wrap gap-2.5 justify-start items-center">
        {accents.map((a) => (
          <button
            ...
            className={cn(
              "h-4.5 w-4.5 rounded-full border-2 border-transparent bg-clip-padding p-0 transition-[transform,box-shadow] duration-150 active:scale-[0.96]",
