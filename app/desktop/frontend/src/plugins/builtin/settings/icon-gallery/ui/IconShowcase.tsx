...
function ShowcaseCard({ id }: { id: string }) {
  ...
  return (
    <div
      title={`${title} — ${id}`}
      className="flex cursor-default flex-col items-center gap-1.5 rounded-md bg-surface px-2 pb-2 pt-2.5 transition-colors duration-[var(--dur-fast)] hover:bg-hover"
    >
