  ...
  return (
    <div className="pb-1.5">
      ...
      {view.rows.map((tool) => (
        ...
        >
          <code className="rounded-sm bg-surface-2 px-1 font-mono text-ui-sm text-fg">
            {tool.name}
          </code>
        ...
        {(rows) => (
          <>
            ...
            <button
              ...
              className="m-0 flex items-center gap-1.5 px-4 pt-3.5 pb-4.5 text-ui-sm leading-[1.5] text-fg-muted hover:text-fg"
            >
