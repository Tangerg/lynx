      ...
      <div className="flex flex-col gap-3 px-4">
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-full rounded-md border border-line-soft bg-surface px-2.5 py-1.5 text-[12px] text-fg outline-none placeholder:text-fg-faint focus:border-accent"
          />
          <PillButton
            variant="accent"
            size="sm"
