  ...
  return (
    <div className="mb-4">
      <button
        ...
        className={cn(
          "flex w-full items-center gap-2 rounded-md border-[0.5px] border-field bg-canvas/70 py-1.5 pl-2.5 pr-2 text-left font-sans text-[13px] text-fg-faint transition-colors hover:bg-canvas hover:text-fg-muted focus-visible:bg-canvas focus-visible:text-fg-muted focus-visible:outline-none",
        )}
      >
