...
// Answers preserve Question.fields order and every field always contributes one
// values array. This is already the wire shape, so no dynamic-key normalization
// or field-name join exists at the boundary.
