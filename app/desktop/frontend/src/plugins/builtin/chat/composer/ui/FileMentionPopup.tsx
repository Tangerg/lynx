...
export function FileMentionPopup({ items, index, onPick, onHover }: Props) {
  const t = useT();
  return (
    <div className="absolute bottom-full left-2 right-2 z-10 mb-2 overflow-hidden rounded-lg border-[0.5px] border-field bg-surface shadow-[var(--shadow-popover)] animate-rise-in">
