      ...
      <RadixTooltip.Root>
        ...
        <RadixTooltip.Portal>
          <RadixTooltip.Content
            ...
            className="z-50 max-w-[280px] rounded-md border border-line-soft bg-surface px-2 py-1 font-sans text-[11.5px] leading-snug text-fg-soft shadow-md animate-rise-in"
          >
            {label}
          </RadixTooltip.Content>
        </RadixTooltip.Portal>
