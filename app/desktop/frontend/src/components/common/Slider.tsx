    ...
    >
      <BaseSlider.Control className="relative flex h-4 grow items-center">
        ...
        <BaseSlider.Thumb
          ...
          className="block h-3.5 w-3.5 rounded-full border border-field bg-fg shadow-[0_1px_2px_rgb(0_0_0_/_0.25)] transition-transform focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        />
      </BaseSlider.Control>
    </BaseSlider.Root>
  );
