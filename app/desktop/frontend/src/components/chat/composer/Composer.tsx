...
export function Composer({
  ...
  return (
    <div
      ...
      className="relative rounded-xl glass px-3 pb-2 pt-2.5 transition-[box-shadow,border-color] duration-150 focus-within:shadow-middle focus-within:border-white/[0.12]"
    >
      {mentions.active && (
        <FileMentionPopup
