...
export const de: Record<string, string> = {
  ...
  "tools.overflow.lines2": "{{count}} weitere Zeilen",
  ...
  "goal.status.active": "Läuft",
  "goal.status.paused": "Angehalten",
  "goal.status.blocked": "Blockiert",
  "goal.status.completing": "Wird abgeschlossen",
  ...
  "goal.stop.awaitingInput": "Wartet auf deine Antwort",
  "goal.stop.terminalOutcomeMissing": "Beendet, ohne ein Ergebnis zu melden",
  "goal.stop.runNotCompleted": "Eine Runde wurde nicht abgeschlossen",
  "goal.stop.runBudgetReached": "Keine Runden mehr",
  "goal.stop.costBudgetReached": "Kein Budget mehr",
  "goal.stop.stepBudgetReached": "Keine Schritte mehr",
  "goal.stop.blockedByModel": "Das Modell wollte anhalten",
  "schedules.off": "Aus",
  ...
  "agent.runOutcome.completed": "Abgeschlossen",
