...
export const de: Record<string, string> = {
  ...
  "composer.usage.hint": "Token-Verbrauch — Eingabe ↑ / Ausgabe ↓ (dieser Lauf)",
  "composer.usage.context": "Genutztes Kontextfenster",
  ...
  "settings.theme.systemSub": "folgt deinem OS",
