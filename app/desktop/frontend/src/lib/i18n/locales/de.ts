...
export const de: Record<string, string> = {
  ...
  "narrative.rail.outline": "In dieser Antwort",
  "outline.entry.reasoning": "Denkprozess",
  "outline.entry.plan": "Plan",
  "outline.entry.approval": "Freigabe",
  "outline.entry.question": "Rückfrage",
  "outline.entry.compaction": "Kontext verdichtet",
  "outline.entry.image": "Bild",
  "role.user": "Du",
