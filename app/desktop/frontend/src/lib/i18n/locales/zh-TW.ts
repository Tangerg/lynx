...
export const zhTW: Record<string, string> = {
  ...
  "composer.usage.hint": "Token 用量 —— 輸入 ↑ / 輸出 ↓（本次執行）",
  "composer.usage.context": "已用上下文視窗",
  ...
  "usage.byModel": "依模型",
  "usage.byDay": "依日期",
  "approvals.mode.plan.desc": "唯讀 —— 只調查並提出計畫，不執行任何動作。",
  ...
  "workspace.view.title.skillDrafts": "技能草稿",
  "skillDrafts.title": "技能草稿",
  "skillDrafts.sub": "{{count}} 筆待審閱",
  "skillDrafts.promote": "採用",
  "skillDrafts.reject": "拒絕",
  "skillDrafts.provenance": "由 {{who}} 提議",
  "skillDrafts.who.agent": "代理",
  "skillDrafts.empty.title": "沒有待審閱的草稿",
  "skillDrafts.empty.sub": "代理從你的工作階段中提煉出的技能會落在這裡等你核准。",
  "skillDrafts.error": "無法處理該草稿。",
  ...
  "goal.setGoal": "為這個工作階段設定目標",
  "goal.startTitle": "目標模式",
  "goal.objective": "目標",
  "goal.objective.placeholder": "希望代理自主推進到什麼結果？",
  "goal.maxTurns": "最大回合數",
  "goal.maxCost": "最大花費（$）",
  "goal.maxSteps": "最大步數",
  "goal.budgetHint": "留空表示不設上限",
  "goal.start": "開始",
  "goal.cancel": "取消",
  "goal.stop": "停止",
  "goal.resume": "繼續",
  ...
  "rpcError.mcp_auth_failed": "驗證被拒絕 —— 檢查 token 後重試。",
