...
export const zhTW: Record<string, string> = {
  ...
  "composer.placeholder": "描述你要做的事，@ 引用檔案或符號，⏎ 傳送",
  ...
  "narrative.rail.outline": "本則回答目錄",
  "outline.entry.reasoning": "思考過程",
  "outline.entry.plan": "執行計畫",
  "outline.entry.approval": "命令審批",
  "outline.entry.question": "澄清提問",
  "outline.entry.compaction": "脈絡壓縮",
  "outline.entry.image": "圖片",
  "role.user": "你",
  "role.assistant": "助手",
  "role.system": "系統",
