...
export const zhTW: Record<string, string> = {
  ...
  "tools.preview.pending.planning": "更新計劃…",
  "tools.preview.pending.goal": "讀取目標…",
  ...
  "tools.preview.idle.planCleared": "（計劃已清空）",
  "tools.preview.idle.noGoal": "（沒有目標）",
