...
export const ko: Record<string, string> = {
  ...
  "goal.meta.model": "모델",
  "goal.meta.lastMove": "마지막 진행",
  "goal.replace.title": "현재 목표를 교체할까요?",
  "goal.replace.body":
    '"{{objective}}"은(는) 여기서 끝나며 이미 사용한 한도도 돌아오지 않습니다. 대화는 그대로 남습니다.',
  "goal.replace.confirm": "목표 교체",
  "goal.stop.stoppedByUser": "직접 중지했습니다",
  "goal.stop.runtimeRestarted": "런타임이 다시 시작되었습니다",
  "goal.stop.runStartFailed": "턴을 시작하지 못했습니다",
  "goal.stop.awaitingInput": "답변을 기다리는 중입니다",
  "goal.stop.terminalOutcomeMissing": "결과를 알리지 않고 종료했습니다",
  "goal.stop.runNotCompleted": "턴이 끝나지 않았습니다",
  "goal.stop.runBudgetReached": "턴 한도에 도달했습니다",
  "goal.stop.costBudgetReached": "비용 한도에 도달했습니다",
  "goal.stop.stepBudgetReached": "스텝 한도에 도달했습니다",
  "goal.stop.blockedByModel": "모델이 중지를 요청했습니다",
  "schedules.off": "꺼짐",
  ...
  "agent.runOutcome.completed": "완료됨",
  ...
  "context.usage.tooltip": "{used} / {window} 토큰 사용",
