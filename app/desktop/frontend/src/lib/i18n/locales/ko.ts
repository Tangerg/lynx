...
export const ko: Record<string, string> = {
  ...
  "narrative.rail.outline": "이 답변의 목차",
  "outline.entry.reasoning": "사고 과정",
  "outline.entry.plan": "계획",
  "outline.entry.approval": "승인",
  "outline.entry.question": "질문",
  "outline.entry.compaction": "컨텍스트 압축",
  "outline.entry.image": "이미지",
  "role.user": "나",
