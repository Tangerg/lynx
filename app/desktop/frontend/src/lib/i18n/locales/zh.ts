...
export const zh: Record<string, string> = {
  ...
  "goal.expand": "展开额度",
  "goal.collapse": "收起额度",
  "goal.action.start": "开启目标模式",
  "goal.action.stop": "停止目标",
  "goal.action.resume": "恢复目标",
  "goal.start.title": "开启自主目标",
  "goal.start.description": "运行时会持续发起新轮次来推进这个目标。",
  "goal.start.objective": "目标",
  "goal.start.optionalLimits": "可选额度",
  "goal.start.maxRuns": "轮次",
  "goal.start.maxCost": "花费（美元）",
  "goal.start.maxSteps": "步数",
  "goal.start.uncapped": "某项留空表示该项不设上限。",
  "goal.start.running": "正在开启…",
  "goal.error.start": "无法开启目标模式",
  "goal.error.stop": "无法停止目标",
  "goal.error.resume": "无法继续目标",
  "slash.goal": "设定一个让智能体持续追求的目标",
  "goal.error.unavailable": "现在无法设定目标 —— 该运行时可能不支持目标，或者已有一个在运行",
  "goal.meta.model": "模型",
  "goal.meta.lastMove": "最近一次推进",
  "goal.replace.title": "替换当前目标？",
  "goal.replace.body": "“{{objective}}”将就此结束，已消耗的额度不会退回。对话会保留。",
  "goal.replace.confirm": "替换目标",
  "goal.stop.stoppedByUser": "你手动停止了",
  "goal.stop.runtimeRestarted": "运行时重启了",
  "goal.stop.runStartFailed": "有一轮没能启动",
  "goal.stop.awaitingInput": "在等你回答",
  "goal.stop.terminalOutcomeMissing": "结束了，但没有给出结果",
  "goal.stop.runNotCompleted": "有一轮没有跑完",
  "goal.stop.runBudgetReached": "轮次用尽",
  "goal.stop.costBudgetReached": "花费用尽",
  "goal.stop.stepBudgetReached": "步数用尽",
  "goal.stop.blockedByModel": "模型主动要求停下",
  "schedules.off": "已停用",
  ...
  "context.usage.aria": "上下文占用：{percent}%",
