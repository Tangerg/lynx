...
export const zh: Record<string, string> = {
  ...
  "tools.preview.pending.planning": "更新计划…",
  "tools.preview.pending.goal": "读取目标…",
  ...
  "tools.preview.idle.planCleared": "（计划已清空）",
  "tools.preview.idle.noGoal": "（没有目标）",
