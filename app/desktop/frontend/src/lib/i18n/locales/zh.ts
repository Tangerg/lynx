...
export const zh: Record<string, string> = {
  ...
  "composer.placeholder": "描述你要做的事，@ 引用文件或符号，⏎ 发送",
  ...
  "narrative.rail.outline": "本条回答目录",
  "outline.entry.reasoning": "思考过程",
  "outline.entry.plan": "执行计划",
  "outline.entry.approval": "命令审批",
  "outline.entry.question": "澄清提问",
  "outline.entry.compaction": "上下文压缩",
  "outline.entry.image": "图片",
  "role.user": "你",
  "role.assistant": "助手",
  "role.system": "系统",
