...
export const zh: Record<string, string> = {
  ...
  "welcome.title": "我们应该在 lynx 中构建什么？",
  ...
  "approvals.mode.plan.desc": "只读 — 调研并给出计划，不执行任何改动。",
  ...
  "schedules.form.prompt": "要运行的 prompt…",
  ...
  "skillDrafts.sub": "{{count}} 条待审阅",
  "skillDrafts.promote": "采纳",
  "skillDrafts.reject": "拒绝",
  "skillDrafts.provenance": "由 {{who}} 提议",
  "skillDrafts.who.agent": "智能体",
  "skillDrafts.empty.title": "没有待审阅的草稿",
  "skillDrafts.empty.sub": "智能体从你的会话中提炼出的技能会落在这里等你批准。",
  "skillDrafts.error": "无法处理该草稿。",
  ...
  "goal.setGoal": "为这个会话设定目标",
  "goal.startTitle": "目标模式",
  "goal.objective": "目标",
  "goal.objective.placeholder": "希望智能体自主推进到什么结果？",
  "goal.maxTurns": "最大轮次",
  "goal.maxCost": "最大花费（$）",
  "goal.maxSteps": "最大步数",
  "goal.budgetHint": "留空表示不设上限",
  "goal.start": "开始",
  "goal.cancel": "取消",
  "goal.stop": "停止",
  "goal.resume": "继续",
  ...
  "rpcError.mcp_auth_failed": "认证被拒绝 —— 检查 token 后重试。",
  ...
  "danger.recursiveDelete": "递归 / 强制删除",
  "danger.runsAsRoot": "以 root 运行",
  "danger.pipeToShell": "把下载内容管道进 shell",
  "danger.overwritesDevice": "直接覆写设备（dd）",
  "danger.formatsFilesystem": "格式化文件系统",
  "danger.worldWritable": "全局可写（chmod 777）",
