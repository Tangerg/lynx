...
export const zh: Record<string, string> = {
  ...
  "composer.queued.hint": "已排队 ({{count}}) · 当前运行结束后发送",
  "composer.queued.image": "(图片)",
  "composer.queued.remove": "移出队列",
  ...
  "tools.empty.sub": "在 {{path}} 中添加服务器以向 agent 暴露工具。",
  "tools.footer": "服务器暴露 agent 可调用的工具。编辑 {{path}} 进行添加或移除。",
  "tools.status.on": "开",
  "tools.status.off": "关",
  ...
  "tools.auth.placeholder": "粘贴访问令牌…",
  "tools.auth.submit": "认证",
  "tools.auth.aria": "{{server}} 访问令牌",
  ...
  "statusbar.compact.label": "压缩上下文 —— 总结更早的消息以释放空间",
  "statusbar.compact.busy": "压缩中…",
  "statusbar.compact.idle": "压缩",
  "statusbar.compact.error": "无法压缩会话。",
  "statusbar.ttft.label": "首 token 时间",
  "statusbar.ttft.waiting": "等待首个 token…",
  "statusbar.ttft.detail": "TTFT {{ms}}ms · 实时 tokens/秒",
