...
export const fr: Record<string, string> = {
  ...
  "settings.streamRender": "Style de diffusion",
  "settings.streamRender.sub": "Comment les réponses apparaissent au fil du streaming.",
  "settings.streamRender.smooth": "Fluide",
  "settings.streamRender.typewriter": "Machine à écrire",
