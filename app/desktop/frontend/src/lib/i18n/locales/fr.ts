...
export const fr: Record<string, string> = {
  ...
  "window.action.close": "Fermer la fenêtre",
  "window.action.minimise": "Réduire la fenêtre",
  "window.action.maximise": "Agrandir la fenêtre",
  "window.action.restore": "Restaurer la fenêtre",
  "shell.region.workspace": "Espace de travail de l'agent",
  "workIndex.identity.none": "Aucun espace de travail",
  ...
  "composer.placeholder":
    "Décrivez ce que vous voulez faire — @ pour référencer un fichier, ⏎ pour envoyer",
  ...
  "narrative.rail.outline": "Dans cette réponse",
  "role.user": "Vous",
  ...
  "approvals.mode.plan.desc": "Lecture seule — enquête et propose un plan ; rien ne s'exécute.",
  ...
  "workspace.view.title.skillDrafts": "Brouillons de compétences",
  "skillDrafts.title": "Brouillons de compétences",
  "skillDrafts.sub": "{{count}} en attente de revue",
  "skillDrafts.promote": "Promouvoir",
  "skillDrafts.reject": "Rejeter",
  "skillDrafts.provenance": "Proposé par {{who}}",
  "skillDrafts.who.agent": "l'agent",
  "skillDrafts.empty.title": "Aucun brouillon à examiner",
  "skillDrafts.empty.sub":
    "Les compétences que l'agent distille de vos sessions arrivent ici pour votre approbation.",
  "skillDrafts.error": "Impossible de traiter le brouillon.",
  ...
  "goal.setGoal": "Définir un objectif pour cette session",
  "goal.startTitle": "Mode objectif",
  "goal.objective": "Objectif",
  "goal.objective.placeholder": "Vers quoi l'agent doit-il avancer de lui-même ?",
  "goal.maxTurns": "Tours max",
  "goal.maxCost": "Coût max ($)",
  "goal.maxSteps": "Étapes max",
  "goal.budgetHint": "Laissez vide pour aucune limite",
  "goal.start": "Démarrer",
  "goal.cancel": "Annuler",
  "goal.stop": "Arrêter",
  ...
  "goal.error": "Impossible de mettre à jour l'objectif.",
