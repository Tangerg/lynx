...
export const fr: Record<string, string> = {
  ...
  "workspace.view.title.context": "Contexte",
  ...
  "composer.usage.hint": "Consommation de tokens — entrée ↑ / sortie ↓ (cette exécution)",
  "composer.usage.context": "Fenêtre de contexte utilisée",
  ...
  "settings.theme.systemSub": "suit votre OS",
