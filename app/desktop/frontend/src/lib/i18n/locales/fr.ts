...
export const fr: Record<string, string> = {
  ...
  "goal.status.completing": "Finalisation",
  ...
  "goal.action.start": "Lancer l’objectif",
  "goal.action.stop": "Arrêter",
  "goal.action.resume": "Reprendre",
  "goal.start.title": "Lancer un objectif autonome",
  "goal.start.description": "Le runtime lancera des tours successifs pour poursuivre cet objectif.",
  "goal.start.objective": "Objectif",
  "goal.start.optionalLimits": "Limites facultatives",
  "goal.start.maxRuns": "Tours",
  "goal.start.maxCost": "Coût (USD)",
  "goal.start.maxSteps": "Étapes",
  "goal.start.uncapped": "Laissez une limite vide pour ne pas plafonner cette ressource.",
  "goal.start.running": "Lancement…",
  ...
  "settings.connection.sub": "Adresse du runtime Lyra. L’application reconnecte le bureau.",
  ...
  "runtime.connection.unavailable":
    "Le runtime est indisponible. Lyra continuera de tenter de se reconnecter.",
