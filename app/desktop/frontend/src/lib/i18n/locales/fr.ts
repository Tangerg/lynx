...
export const fr: Record<string, string> = {
  ...
  "tools.preview.pending.planning": "Mise à jour du plan…",
  "tools.preview.pending.goal": "Lecture de l'objectif…",
  ...
  "tools.preview.idle.planCleared": "(plan vidé)",
  "tools.preview.idle.noGoal": "(aucun objectif)",
