...
export const ja: Record<string, string> = {
  ...
  "narrative.rail.outline": "この回答の目次",
  "outline.entry.reasoning": "思考",
  "outline.entry.plan": "計画",
  "outline.entry.approval": "承認",
  "outline.entry.question": "確認",
  "outline.entry.compaction": "コンテキスト圧縮",
  "outline.entry.image": "画像",
  "role.user": "あなた",
