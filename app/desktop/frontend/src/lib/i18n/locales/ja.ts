...
export const ja: Record<string, string> = {
  ...
  "goal.stop.awaitingInput": "回答を待っています",
  "goal.stop.terminalOutcomeMissing": "結果を報告せずに終了しました",
  "goal.stop.runNotCompleted": "ターンが完了しませんでした",
  "goal.stop.runBudgetReached": "ターンの上限に達しました",
  "goal.stop.costBudgetReached": "コストの上限に達しました",
  "goal.stop.stepBudgetReached": "ステップの上限に達しました",
  "goal.stop.blockedByModel": "モデルが停止を求めました",
  "schedules.off": "停止中",
