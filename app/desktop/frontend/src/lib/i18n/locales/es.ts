...
export const es: Record<string, string> = {
  ...
  "tools.overflow.lines2": "{{count}} líneas más",
  ...
  "goal.status.active": "En curso",
  "goal.status.paused": "En pausa",
  "goal.status.blocked": "Bloqueado",
  "goal.budget.runs": "Turnos",
  "goal.budget.cost": "Coste",
  "goal.budget.steps": "Pasos",
  "goal.budget.uncapped": "sin límite",
  ...
  "goal.stop.awaitingInput": "Esperando tu respuesta",
  "goal.stop.terminalOutcomeMissing": "Terminó sin informar un resultado",
  "goal.stop.runNotCompleted": "Un turno no terminó",
  "goal.stop.runBudgetReached": "Sin turnos disponibles",
  "goal.stop.costBudgetReached": "Sin presupuesto disponible",
  "goal.stop.stepBudgetReached": "Sin pasos disponibles",
  "goal.stop.blockedByModel": "El modelo pidió detenerse",
