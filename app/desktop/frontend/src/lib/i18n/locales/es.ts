...
export const es: Record<string, string> = {
  ...
  "narrative.rail.outline": "En esta respuesta",
  "outline.entry.reasoning": "Razonamiento",
  "outline.entry.plan": "Plan",
  "outline.entry.approval": "Aprobación",
  "outline.entry.question": "Pregunta",
  "outline.entry.compaction": "Contexto compactado",
  "outline.entry.image": "Imagen",
  "role.user": "Tú",
