...
export const es: Record<string, string> = {
  ...
  "goal.setGoal": "Fijar un objetivo para esta sesión",
  "goal.startTitle": "Modo objetivo",
  "goal.objective": "Objetivo",
  "goal.objective.placeholder": "¿Hacia qué debe avanzar el agente por su cuenta?",
  "goal.maxTurns": "Turnos máx.",
  "goal.maxCost": "Coste máx. ($)",
  "goal.maxSteps": "Pasos máx.",
  "goal.budgetHint": "Déjalo en blanco para no poner límite",
  "goal.start": "Iniciar",
  ...
  "goal.error": "No se pudo actualizar el objetivo.",
