...
func (value ProblemData) ValidateWire() error {
	return collectWireViolations("ProblemData",
		...
		forbiddenWhen(wireFieldEquals(value, "type", "idempotency_store_mismatch"), "requiredCapabilities", value),
		forbiddenWhen(wireFieldEquals(value, "type", "idempotency_store_mismatch"), "retryAfterSeconds", value),
		forbiddenWhen(wireFieldEquals(value, "type", "idempotency_store_mismatch"), "errors", value),
		forbiddenWhen(wireFieldEquals(value, "type", "idempotency_store_mismatch"), "activeRun", value),
...
func (value RunOutcome) ValidateWire() error {
	return collectWireViolations("RunOutcome",
		closedEnum("type", string(value.Type), []string{"completed", "timedOut", "failed", "maxSteps", "maxBudget", "canceled", "lost"}, false),
		...
		requiredWhen(wireFieldEquals(value, "type", "timedOut"), "error", value),
		forbiddenWhen(wireFieldEquals(value, "type", "timedOut"), "detail", value),
		requiredWhen(wireFieldEquals(value, "type", "failed"), "error", value),
		forbiddenWhen(wireFieldEquals(value, "type", "failed"), "detail", value),
		...
		requiredWhen(wireFieldEquals(value, "type", "lost"), "error", value),
		forbiddenWhen(wireFieldEquals(value, "type", "lost"), "detail", value),
		requiredWhen(wireFieldEquals(value, "type", "timedOut"), "error", value),
		forbiddenWhen(wireFieldEquals(value, "type", "timedOut"), "detail", value),
		requiredWhen(wireFieldEquals(value, "type", "failed"), "error", value),
		forbiddenWhen(wireFieldEquals(value, "type", "failed"), "detail", value),
...
func (value SegmentOutcome) ValidateWire() error {
	return collectWireViolations("SegmentOutcome",
		closedEnum("type", string(value.Type), []string{"interrupt", "suspended", "completed", "timedOut", "failed", "maxSteps", "maxBudget", "canceled", "lost"}, false),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "completed"), "detail", value),
		requiredWhen(wireFieldEquals(value, "type", "timedOut"), "error", value),
		forbiddenWhen(wireFieldEquals(value, "type", "timedOut"), "interrupts", value),
		forbiddenWhen(wireFieldEquals(value, "type", "timedOut"), "detail", value),
		requiredWhen(wireFieldEquals(value, "type", "failed"), "error", value),
		forbiddenWhen(wireFieldEquals(value, "type", "failed"), "interrupts", value),
		forbiddenWhen(wireFieldEquals(value, "type", "failed"), "detail", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "canceled"), "error", value),
		requiredWhen(wireFieldEquals(value, "type", "lost"), "error", value),
		forbiddenWhen(wireFieldEquals(value, "type", "lost"), "interrupts", value),
		forbiddenWhen(wireFieldEquals(value, "type", "lost"), "detail", value),
		requiredWhen(wireFieldEquals(value, "type", "timedOut"), "error", value),
		forbiddenWhen(wireFieldEquals(value, "type", "timedOut"), "detail", value),
		requiredWhen(wireFieldEquals(value, "type", "failed"), "error", value),
...
func (value Item) ValidateWire() error {
	return collectWireViolations("Item",
		...
		closedEnum("phase", string(value.Phase), []string{"commentary", "finalAnswer"}, true),
		closedEnum("safetyClass", string(value.SafetyClass), []string{"safe", "write", "exec", "network"}, true),
		closedEnum("approvalDecision", string(value.ApprovalDecision), []string{"approve", "deny"}, true),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "userMessage"), "phase", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "userMessage"), "approvalDecision", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "agentMessage"), "approvalDecision", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "reasoning"), "phase", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "reasoning"), "approvalDecision", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "question"), "phase", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "question"), "approvalDecision", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "toolCall"), "phase", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "compaction"), "phase", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "compaction"), "approvalDecision", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "agentMessage") && wireFieldEquals(value, "status", "running"), "phase", value),
		requiredWhen(wireFieldEquals(value, "type", "agentMessage") && wireFieldEquals(value, "status", "completed"), "phase", value),
		requiredWhen(wireFieldEquals(value, "type", "agentMessage") && wireFieldEquals(value, "status", "incomplete"), "phase", value),
	)
}
...
func (value RuntimeEvent) ValidateWire() error {
	return collectWireViolations("RuntimeEvent",
		...
		forbiddenWhen(wireFieldEquals(value, "type", "models.changed"), "paths", value),
		forbiddenWhen(wireFieldEquals(value, "type", "models.changed"), "watchId", value),
		forbiddenWhen(wireFieldEquals(value, "type", "models.changed"), "workspace", value),
		forbiddenWhen(wireFieldEquals(value, "type", "models.changed"), "names", value),
		forbiddenWhen(wireFieldEquals(value, "type", "models.changed"), "serverIds", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "approvals.changed"), "paths", value),
		forbiddenWhen(wireFieldEquals(value, "type", "approvals.changed"), "watchId", value),
		forbiddenWhen(wireFieldEquals(value, "type", "approvals.changed"), "workspace", value),
		forbiddenWhen(wireFieldEquals(value, "type", "approvals.changed"), "names", value),
		forbiddenWhen(wireFieldEquals(value, "type", "approvals.changed"), "serverIds", value),
		...
		forbiddenWhen(wireFieldEquals(value, "type", "agentMemory.changed"), "paths", value),
		forbiddenWhen(wireFieldEquals(value, "type", "agentMemory.changed"), "watchId", value),
		forbiddenWhen(wireFieldEquals(value, "type", "agentMemory.changed"), "workspace", value),
		forbiddenWhen(wireFieldEquals(value, "type", "agentMemory.changed"), "names", value),
		forbiddenWhen(wireFieldEquals(value, "type", "agentMemory.changed"), "serverIds", value),
...
func (value ArtifactItem) ValidateWire() error {
	return collectWireViolations("ArtifactItem",
		...
		requiredWhen(wireFieldEquals(value, "type", "agentMessage"), "status", value),
		requiredWhen(wireFieldEquals(value, "type", "agentMessage"), "createdAt", value),
		requiredWhen(wireFieldEquals(value, "type", "agentMessage"), "phase", value),
		forbiddenWhen(wireFieldEquals(value, "type", "agentMessage"), "text", value),
		forbiddenWhen(wireFieldEquals(value, "type", "agentMessage"), "redacted", value),
		forbiddenWhen(wireFieldEquals(value, "type", "agentMessage"), "question", value),
		forbiddenWhen(wireFieldEquals(value, "type", "agentMessage"), "startedAt", value),
