...
require (
	...
	github.com/Tangerg/scope/models/openai v0.0.2
	github.com/Tangerg/scope/models/openrouter v0.0.1
	github.com/Tangerg/scope/models/perplexity v0.0.1
	github.com/Tangerg/scope/models/protocol/openai v0.0.2
...
require (
	...
	github.com/Tangerg/scope/models/protocol/anthropic v0.0.2 // indirect
