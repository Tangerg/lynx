// Package approvaltest provides an in-memory [approvals.RuleStore] for tests.
//
...
// MemoryStore is an in-process [approvals.RuleStore] for tests. Rules die with
...
var _ approvals.RuleStore = (*MemoryStore)(nil)
