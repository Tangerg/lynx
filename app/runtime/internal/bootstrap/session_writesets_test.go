...
func park(t *testing.T, runs *sqlite.RunStateStore, ints *sqlite.InterruptStore, processes *sqlite.ProcessStore, sessionID, runID string) string {
	...
	if err := processes.Apply(ctx, core.SnapshotMutation{Writes: []core.ProcessSnapshot{bootstrapWaitingSnapshot(processID)}}); err != nil {
...
func TestApplyTerminalDropsInterruptAndTerminalizes(t *testing.T) {
	...
	child.Depth = 1
	if err := ss.processes.Apply(ctx, core.SnapshotMutation{Writes: []core.ProcessSnapshot{child}}); err != nil {
...
func TestApplyRollbackDeletesSubtaskSetAtomically(t *testing.T) {
	...
	if err := ss.processes.Apply(ctx, core.SnapshotMutation{Writes: []core.ProcessSnapshot{bootstrapWaitingSnapshot("proc_preserve")}}); err != nil {
