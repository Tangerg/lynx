...
// must therefore have a spec. The one the contract also names — CancelRunResponse —
// arrives later in the vNext cutover; registering a shape for a type nobody can send
// would check nothing.
//
