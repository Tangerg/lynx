...
func TestEveryWireUnionIsRegistered(t *testing.T) {
	...
	want := []string{
		...
		"ItemListScope", "McpAuthorizationChange", "McpConnection", "McpConnectionInput", "McpEnvironmentChange", "McpHeadersChange", "McpServerState", "ProblemData", "ProviderConfigChange", "QuestionField", "RunOutcome", "RuntimeEvent", "SegmentOutcome", "StateSnapshot", "StreamEvent",
	}
