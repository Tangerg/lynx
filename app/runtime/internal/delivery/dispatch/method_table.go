...
var methodTable = map[string]methodHandler{
	...
	MethodWorkspaceListManagedSkills: (*Dispatcher).handleWorkspaceListManagedSkills,
	MethodWorkspaceArchiveSkill:      (*Dispatcher).handleWorkspaceArchiveSkill,
	MethodWorkspaceRestoreSkill:      (*Dispatcher).handleWorkspaceRestoreSkill,
