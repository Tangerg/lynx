...
var methodTable = map[string]methodHandler{
	...
	MethodSkillsDraftsList:     (*Dispatcher).handleSkillsDraftsList,
	MethodSkillsDraftsPromote:  (*Dispatcher).handleSkillsDraftsPromote,
	MethodSkillsDraftsReject:   (*Dispatcher).handleSkillsDraftsReject,
