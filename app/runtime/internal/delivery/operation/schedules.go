...
func registerSchedules(registry *Registry) {
	...
	}, func(service Service, ctx context.Context, request protocol.PageQuery) (*protocol.Page[protocol.Schedule], error) {
	...
	}, func(service Service, ctx context.Context, request protocol.CreateScheduleRequest) (*protocol.Schedule, error) {
	...
	}, func(service Service, ctx context.Context, request protocol.UpdateScheduleRequest) (*protocol.Schedule, error) {
	...
	}, func(service Service, ctx context.Context, request protocol.DeleteScheduleRequest) error {
	...
	}, func(service Service, ctx context.Context, request protocol.RunScheduleNowRequest) (*protocol.RunScheduleNowResponse, error) {
