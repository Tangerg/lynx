...
func (*fakeMCPLive) ProbeMCPServer(context.Context, toolport.MCPServerConfig) error     { return nil }
func (*fakeMCPLive) ConfigureMCPServer(context.Context, toolport.MCPServerConfig) error { return nil }
...
// reconnect/configure paths publish through.
func serverWithMCP(cfg capabilities.Config) *Server {
	...
	return &Server{capabilities: capabilities.New(cfg), wsHub: newWorkspaceHub()}
}
