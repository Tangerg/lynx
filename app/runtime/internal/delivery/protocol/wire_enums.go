...
var wireEnums = map[reflect.Type][]string{
	...
	reflect.TypeFor[ArtifactOutcomeType]():               {string(ArtifactOutcomeCompleted), string(ArtifactOutcomeTimedOut), string(ArtifactOutcomeFailed), string(ArtifactOutcomeMaxSteps), string(ArtifactOutcomeMaxBudget), string(ArtifactOutcomeCanceled), string(ArtifactOutcomeLost)},
	reflect.TypeFor[ArtifactStateType]():                 {string(ArtifactStatePlan)},
	...
	reflect.TypeFor[CapabilityRequirementType]():         {string(RequirementFeature), string(RequirementInterruptType), string(RequirementRuntimeTopic), string(RequirementStateSnapshot)},
	reflect.TypeFor[CancelRunResponseType]():             {string(CancelRunRoot), string(CancelRunChild)},
	reflect.TypeFor[RecoveryAction]():                    {string(RecoveryRefetch), string(RecoveryColdRecover), string(RecoveryResubscribe), string(RecoveryReauthenticate), string(RecoveryWaitRetryAfter), string(RecoveryPromptUser), string(RecoveryStop)},
	reflect.TypeFor[GoalStatus]():                        {string(GoalActive), string(GoalPaused), string(GoalBlocked)},
	reflect.TypeFor[GoalReasonCode]():                    {string(GoalReasonStoppedByUser), string(GoalReasonRuntimeRestarted), string(GoalReasonRunStartFailed), string(GoalReasonAwaitingInput), string(GoalReasonTerminalOutcomeMissing), string(GoalReasonRunNotCompleted), string(GoalReasonRunBudgetReached), string(GoalReasonCostBudgetReached), string(GoalReasonStepBudgetReached), string(GoalReasonBlockedByModel)},
	...
	reflect.TypeFor[ItemDeltaType]():                     {string(DeltaContent), string(DeltaReasoning), string(DeltaToolArguments), string(DeltaToolOutput)},
	...
	reflect.TypeFor[RunOutcomeType]():                    {string(OutcomeCompleted), string(OutcomeTimedOut), string(OutcomeFailed), string(OutcomeMaxSteps), string(OutcomeMaxBudget), string(OutcomeCanceled), string(OutcomeLost)},
	...
	reflect.TypeFor[SegmentOutcomeType]():                {string(SegmentInterrupt), string(SegmentSuspended), string(SegmentCompleted), string(SegmentTimedOut), string(SegmentFailed), string(SegmentMaxSteps), string(SegmentMaxBudget), string(SegmentCanceled), string(SegmentLost)},
	...
	reflect.TypeFor[SkillScope]():                        {string(SkillScopeProject), string(SkillScopeUser)},
	reflect.TypeFor[SkillProposalOrigin]():               {string(SkillProposalOriginRequested), string(SkillProposalOriginMined)},
	reflect.TypeFor[StateSnapshotType]():                 {string(StatePlan)},
	...
	reflect.TypeFor[PlanStatus]():                        {string(PlanStatusPending), string(PlanStatusInProgress), string(PlanStatusCompleted)},
