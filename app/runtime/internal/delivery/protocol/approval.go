...
// default tool-permission stance. A session in Plan mode temporarily overrides
// this fallback without changing it for other sessions.
type Approval interface {
	...
	// SetApprovalMode sets the runtime default tool-permission stance.
