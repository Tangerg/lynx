...
// CanonicalSamples returns that binding, grouped the way the canonical docs
...
func CanonicalSamples() []CanonicalSample {
	return []CanonicalSample{
		...
		{"skillProposal.json", reflect.TypeFor[SkillProposal]()},
		...
		{"knowledgeEntry.json", reflect.TypeFor[KnowledgeEntry]()},
