...
var temporaryOldAgentImports = map[string]temporaryImportAllowance{
	...
	"internal/adapter/toolset/delegation/delegation.go":                        {2, "adapter/toolset legacy framework tool bridge", "P8"},
	"internal/adapter/toolset/discovery/discovery.go":                          {1, "adapter/toolset legacy framework tool bridge", "P8"},
	"internal/adapter/toolset/discovery/discovery_test.go":                     {1, "adapter/toolset legacy framework tool fixtures", "P8"},
	"internal/adapter/toolset/exposure_test.go":                                {1, "adapter/toolset legacy framework tool fixtures", "P8"},
	"internal/adapter/toolset/pathlock.go":                                     {1, "adapter/toolset legacy framework tool bridge", "P8"},
	"internal/adapter/toolset/pathlock_test.go":                                {1, "adapter/toolset legacy framework tool fixtures", "P8"},
	"internal/adapter/toolset/resolver.go":                                     {1, "adapter/toolset legacy framework tool bridge", "P8"},
	"internal/adapter/toolset/resolver_discovery_test.go":                      {1, "adapter/toolset legacy framework tool fixtures", "P8"},
	"internal/adapter/toolset/resolver_roles_test.go":                          {1, "adapter/toolset legacy framework tool fixtures", "P8"},
