...
var wireEnums = map[reflect.Type][]string{
	...
	reflect.TypeFor[protocol.GoalStatus]():                        {string(protocol.GoalActive), string(protocol.GoalPaused), string(protocol.GoalBlocked)},
	...
	reflect.TypeFor[protocol.InterruptResponseType]():             {string(protocol.InterruptResponseApproval), string(protocol.InterruptResponseAnswer), string(protocol.InterruptResponseToolResult)},
	reflect.TypeFor[protocol.InterruptType]():                     {string(protocol.InterruptApproval), string(protocol.InterruptQuestion), string(protocol.InterruptToolResult)},
	...
	reflect.TypeFor[protocol.StreamEventType]():                   {string(protocol.StreamSegmentStarted), string(protocol.StreamSegmentProgress), string(protocol.StreamSegmentFinished), string(protocol.StreamItemStarted), string(protocol.StreamItemDelta), string(protocol.StreamItemCompleted), string(protocol.StreamStateSnapshot), string(protocol.StreamCustom)},
