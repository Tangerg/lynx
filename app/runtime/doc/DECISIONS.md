...
- 状态：已接受并实施，P172 完成；允许 model-facing Tool schema/response breaking change，只修改 `app/runtime`，公共 Protocol、Artifact、SQLite、Desktop source、Agent Framework、共享 `tools/fs` 与 CLI 不变。
...
- 状态：已接受并实施，P173 完成；只修改 `app/runtime`，公共 Protocol shape、Artifact、SQLite、generated binding、Desktop source、Agent Framework、共享 `skills`/`tools/skills` 与 CLI 不变。
...
- 状态：已接受并实施，P174 完成；修改 `app/runtime` 与 `app/desktop`，公共 Go API breaking 增加 `runtime/localruntime` 并删除 internal HTTP 的 `LocalToken/OpenLocalToken` owner；Protocol、Artifact、SQLite、Wails binding、Agent Framework 与 `app/cli` 不变。
...
- 状态：已接受并实施，P176 完成；只修改 `app/runtime` internal Checkpoint/Git Infra、架构门禁、测试与文档，公共 Protocol、Artifact、SQLite、公共 Go API、Desktop source、Wails binding、Agent Framework 与 CLI 不变。
...
- 状态：已接受并实施，P177 完成；只修改 `app/runtime` internal Sandbox process writer、测试与文档，公共 Protocol、Artifact、SQLite、公共 Go API、Desktop source、Wails binding、Agent Framework 与 CLI 不变。
...
- 状态：已接受并实施，P180 完成；只修改 `app/runtime` internal Shell Infra/Tool consumer、测试与文档，公共 Shell Tool name/request/response shape、Protocol、Artifact、SQLite、公共 Go API、Desktop source、Wails binding、Agent Framework 与 CLI 不变。
