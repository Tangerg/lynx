...
> 状态：**进行中，当前批次 B7 Agent generic nested suspension / checkpoint**
>
> 建立日期：2026-07-16
>
...
| B7 | Agent generic nested suspension / checkpoint 原语 | B6 | 进行中 |
...
| B7 Agent Nested Suspension | 进行中 | 2026-07-16 | — | — | 审计 agent-as-tool waiting、parent/child snapshot 与 resume continuation |
| B8 Runtime HITL | 待执行 | — | — | — | — |
