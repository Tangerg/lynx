...
- [ ] P113-05 按锁、生命周期与不变量重塑 `runs.Coordinator` 和 `agentexec.interactionSession` 的 package-private state owner，并删除 Dependencies/Config 到对象字段的一比一镜像；不建立新微包、service locator 或存储 façade；
