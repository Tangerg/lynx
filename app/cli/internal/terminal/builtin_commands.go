...
func builtinCommands() []localCommand {
	return slices.Concat(
		...
		commandGroup(commandCategoryWorkspace,
			...
			localCommand{Descriptor: CommandDescriptor{Name: "read", Title: "read an authoritative workspace file", Arguments: RequiredArguments}, Available: availableWithWorkspaceService, Run: func(a *app, path string) error { a.ReadWorkspaceFile(path); return nil }},
		),
