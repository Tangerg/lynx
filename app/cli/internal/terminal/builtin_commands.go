...
func builtinCommands() []localCommand {
	return slices.Concat(
		...
		commandGroup(commandCategorySessions,
			...
			localCommand{Descriptor: CommandDescriptor{Name: "fork", Title: "fork the complete current session"}, Available: availableWithoutActiveRun, Run: func(a *app, title string) error { a.ForkSession(title); return nil }},
		...
		commandGroup(commandCategoryRuntime,
			...
			localCommand{Descriptor: CommandDescriptor{Name: "usage", Title: "inspect session and runtime usage"}, Available: availableWithUsage, Run: func(a *app, days string) error { return a.ShowUsage(days) }},
		...
		commandGroup(commandCategoryContext,
			...
			localCommand{Descriptor: CommandDescriptor{Name: "memory", Title: "inspect governed agent memory by scope"}, Available: availableWithAgentMemory, Run: func(a *app, scope string) error { return a.ShowAgentMemory(scope) }},
			localCommand{Descriptor: CommandDescriptor{Name: "memory-add", Title: "author a new active memory item"}, Available: availableWithAgentMemory, Run: func(a *app, scope string) error { return a.AddAgentMemory(scope) }},
		...
		commandGroup(commandCategoryConnections,
			...
			localCommand{Descriptor: CommandDescriptor{Name: "mcp-tools", Title: "inspect MCP tools, optionally for one server"}, Available: availableWithMCP, Run: func(a *app, server string) error { a.ShowMCPTools(server); return nil }},
