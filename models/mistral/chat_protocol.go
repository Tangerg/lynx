...
// OpenAIChat implements Mistral's OpenAI-compatible endpoint.
type OpenAIChat struct {
	protocol *openai.Chat
}

// OpenAIChatConfig configures Mistral's OpenAI-compatible Core chat adapter.
...
// NewOpenAIChat constructs a Core chat adapter for Mistral.
func NewOpenAIChat(config OpenAIChatConfig) (*OpenAIChat, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("mistral: construct OpenAI-compatible chat: %w", err)
	}
...
func (chat *OpenAIChat) Call(ctx context.Context, request *corechat.Request) (*corechat.Response, error) {
	if chat == nil || chat.protocol == nil {
		return nil, errors.New("mistral: nil OpenAIChat")
	}
...
func (chat *OpenAIChat) Stream(ctx context.Context, request *corechat.Request) iter.Seq2[*corechat.Response, error] {
	if chat == nil || chat.protocol == nil {
		return func(yield func(*corechat.Response, error) bool) { yield(nil, errors.New("mistral: nil OpenAIChat")) }
	}
