...
`protocol/anthropic` implements the reusable Anthropic wire adapters shared by native
...
```bash
go get github.com/Tangerg/scope/models/protocol/anthropic
```

Most consumers never import this module directly. Use `models/anthropic` for the
