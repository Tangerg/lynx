# openai wire protocol architecture

> The reusable OpenAI wire, shared by every provider endpoint that speaks it
> verbatim.

The family contract is [`../../ARCHITECTURE.md`](../../ARCHITECTURE.md);
repository-wide rules are in [`../../../CLAUDE.md`](../../../CLAUDE.md). The
...
- The request and response mapping between Core protocol values and the OpenAI
  wire.
