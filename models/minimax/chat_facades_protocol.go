...
func NewOpenAIChat(cfg OpenAIChatConfig) (*openai.Chat, error) {
	...
	requestOptions := append([]openaioption.RequestOption{openaioption.WithBaseURL(cmp.Or(cfg.BaseURL, BaseURLIntl))}, cfg.RequestOptions...)
...
func NewAnthropicChat(cfg AnthropicChatConfig) (*anthropic.Chat, error) {
	...
	requestOptions := append([]anthropicoption.RequestOption{anthropicoption.WithBaseURL(cmp.Or(cfg.BaseURL, BaseURLIntlAnthropic))}, cfg.RequestOptions...)
