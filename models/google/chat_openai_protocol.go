...
// OpenAIChat implements Gemini's OpenAI-compatible endpoint.
type OpenAIChat struct {
	protocol *openai.Chat
}

// OpenAIChatConfig configures Gemini's OpenAI-compatible Core chat adapter.
...
// NewOpenAIChat constructs an OpenAI-wire Core chat adapter for Gemini.
