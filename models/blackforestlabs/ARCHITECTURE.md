# blackforestlabs architecture

> One model provider. It owns its config, its wire encoding, and its provider
...
- The implementation of the `Model` contracts in `core` that this service
  genuinely supports.
