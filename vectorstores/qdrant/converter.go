...
func (c *Visitor) buildMatchCondition(fieldKey string, fieldValue any) (*qdrant.Condition, error) {
...
func (c *Visitor) buildNestedCondition(expr ast.Expr) (*qdrant.Condition, error) {
	switch node := expr.(type) {
	case *ast.BinaryExpr,
		*ast.UnaryExpr:
