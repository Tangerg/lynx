...
- [`../../doc/AGENT_FRAMEWORK_ARCHITECTURE_REVIEW.md`](../../doc/AGENT_FRAMEWORK_ARCHITECTURE_REVIEW.md)：最终依赖梯级、生命周期所有权、冻结范围和稳定维护规则。
- [`../../doc/AGENT_FRAMEWORK_MIGRATION.md`](../../doc/AGENT_FRAMEWORK_MIGRATION.md)：从旧 Agent 形态一次性直接迁移到当前 Framework 的指南。
- [`../../doc/AGENT_FRAMEWORK_RELEASE_NOTES.md`](../../doc/AGENT_FRAMEWORK_RELEASE_NOTES.md)：当前 release candidate 的功能、破坏性变化、wire 与风险说明。
- [`../../doc/AGENT_FRAMEWORK_V1_RELEASE_RUNBOOK.md`](../../doc/AGENT_FRAMEWORK_V1_RELEASE_RUNBOOK.md)：v1.0.0 的真实 module DAG、tag 波次、门禁和回滚手册。
