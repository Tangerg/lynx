...
// framework. It re-exports the most-used names from core / dsl / runtime
// so callers can write `agent.New(...)` and `agent.NewPlatform(...)`
// without importing five sub-packages.
//
...
// NewCondition wraps a function as a [core.Condition].
