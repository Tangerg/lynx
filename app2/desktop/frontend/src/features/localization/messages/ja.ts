...
export const japaneseMessages = {
  ...
  "activity.followOutput": "出力を追跡",
  "activity.newOutputBelow": "下に新しい出力があります",
  ...
  "settings.shortcuts.scope": "範囲",
  "settings.shortcuts.shortcut": "ショートカット",
  "settings.shortcuts.empty": "この条件に一致するショートカットはありません。",
  "settings.shortcuts.scope.global": "グローバル",
  "settings.shortcuts.scope.session": "セッション",
  "settings.shortcuts.scope.workspace": "ワークスペース",
  "command.newSession": "新しいセッション",
  "command.searchSessions": "セッションを検索",
  "command.searchConversation": "この会話を検索",
  "command.openSettings": "設定を開く",
  "command.closeWorkspaceView": "アクティブなワークスペースビューを閉じる",
  "command.failed": "{command} を実行できませんでした。",
  "toast.region": "通知",
  "toast.dismiss": "通知を閉じる",
  "toast.sessionImported": "{title} をインポートしました。",
  "toast.sessionExported": "{title} を保存しました。",
