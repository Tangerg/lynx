module github.com/Tangerg/lynx/app2/runtime

go 1.26.5

require (
	github.com/Tangerg/lynx v0.0.0-20260805221614-8b3e8b860d00
	github.com/Tangerg/lynx/agent v0.0.0-20260822025749-15500f97b6bf
	github.com/Tangerg/lynx/models v0.0.0-20260822025749-15500f97b6bf
	github.com/Tangerg/lynx/models/google v0.0.0-20260822025749-15500f97b6bf
	github.com/Tangerg/lynx/models/protocol/openai v0.0.0-20260822025749-15500f97b6bf
	github.com/Tangerg/lynx/skills v0.0.0-20260822025749-15500f97b6bf
	github.com/Tangerg/lynx/tools/httpreq v0.0.0
	github.com/Tangerg/lynx/tools/skills v0.0.0-20260822025749-15500f97b6bf
