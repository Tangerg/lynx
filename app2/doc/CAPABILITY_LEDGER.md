...
| U22 | Theme/accent/light-dark/i18n | shell/settings/UI tokens | R10 | in_progress | typed boundary 已覆盖全部主 Agent/Session/Shell/Goal/Plan/file 与 Resources surfaces（含 Skills/Memory mutation lifecycle），仅激活 complete English；Settings、8 个 parity locale、Arabic RTL、locale owner/selector 与 logical CSS 继续生产迁移，完成前不暴露半翻译选择；最终门禁待 R11 |
