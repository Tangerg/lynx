...
| U07 | Delegated Run tree/disclosures | agent presentation | R4 | in_progress | private child admission aggregate + replay-safe SQLite reservation 已建立；pending 不冒充 wire Run，待 started/aborted 原子结论、tree execution、nested disclosure 与 exact cancel |
