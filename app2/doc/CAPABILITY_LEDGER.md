...
| U07 | Delegated Run tree/disclosures | agent presentation | R4 | in_progress | parent Item/reservation 与 started child Run/aborted settlement 的事务边界已建立；pending 不冒充 wire Run、child 不复制 root profile；待 tree execution、nested disclosure 与 exact cancel |
