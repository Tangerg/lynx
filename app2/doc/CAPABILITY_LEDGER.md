...
| U22 | Theme/accent/light-dark/i18n | shell/settings/UI tokens | R10 | in_progress | typed semantic boundary 已覆盖 startup、Agent/HITL/Composer/content、Session/model/Tool/activity、Goal/Plan、Shell 与 file Context Dock，且只激活 complete English；Resources 子页、Settings、8 个 parity locale、Arabic RTL、locale owner/selector 与 logical CSS 继续生产迁移，完成前不暴露半翻译选择；最终门禁待 R11 |
