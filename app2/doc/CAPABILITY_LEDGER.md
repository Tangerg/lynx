...
| U22 | Theme/accent/light-dark/i18n | shell/settings/UI tokens | R10 | in_progress | single-owner theme/accent 与 typed semantic localization boundary 已建立；startup、Agent Narrative、HITL、Composer、recipe、content/media copy 已迁移且只激活 complete English dictionary；其余 Desktop surface、8 个 parity locale、Arabic RTL、locale owner/selector 与 logical CSS 继续生产迁移，完成前不暴露半翻译选择；最终门禁待 R11 |
