...
- Context Dock：files/diff/review/search/tool detail/timeline/terminal/skills/recipes/memory/knowledge/index；
...
| per-session dock tabs/file target | workspace store keyed by Session | one global active file |
